...
const KEYWORDS = Object.keys(CPP_KEYWORD_EMOJI_MAP);

// Sort longest-first so that e.g. "reinterpret_cast" matches before "int".
...
// Group 3 – raw string literal     R"delimiter(...)delimiter"
 ...
 */
function scanCppKeywords(document) {
